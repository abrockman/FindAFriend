...
public class SubscriptionController {
	...
	public Collection<SubscriptionRequest> outstandingSubscriptionRequests(@QueryParam("userId") String userId, @Context HttpServletRequest request, @Context HttpServletResponse response){
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Collection<SubscriptionRequest> getPendingApprovalRequests(@PathParam("userId") String userId, @Context HttpServletRequest request, @Context HttpServletResponse response) {
		Collection<SubscriptionRequest> subReqs = null;
